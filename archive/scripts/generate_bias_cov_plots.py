...
Usage:
    python generate_bias_cov_plots.py --output-dir bias_cov_results
    python generate_bias_cov_plots.py --output-dir bias_cov_results --snr 10
    python generate_bias_cov_plots.py --output-dir bias_cov_results --n-phantoms 10
"""
...
from asl_simulation import ASLParameters, ASLSimulator, _generate_pcasl_signal_jit, _generate_vsasl_signal_jit
...
MODELS = [
    ...
    {
        'name': 'Amplitude-Aware',
        'dir': 'amplitude_ablation_v1/09_AmpAware_Optimized',
        'color': '#d62728',
        'marker': 's',
    },
    {
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='bias_cov_results')
    parser.add_argument('--snr', type=float, nargs='+', default=[3.0, 10.0],
                        help='SNR levels to evaluate')
    parser.add_argument('--n-phantoms', type=int, default=5,
                        help='Number of spatial noise realizations per sweep point (NN)')
    parser.add_argument('--n-ls-realizations', type=int, default=500,
    ...
    meta = {
        ...
        'snr_levels': args.snr,
        'seed': args.seed,
        'models': [m['name'] for m in MODELS] + ['Least Squares'],
        'data': all_csv_rows,
    }
